...
if (isset($_SESSION['authToken'])) {
    if (str_starts_with($_SESSION['authToken'], 'admin_')) {
        header('Location: page_admin.php');
        exit();
    } elseif (str_starts_with($_SESSION['authToken'], 'user_')) {
